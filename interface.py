...
# função da interface de espera
    def esperar(self):
        ...
        while esperando:
            ...
            )*2.1/12, self.tela.get_height()*3/5), 0, self.fonte)
    ...
    def tela_controles(self):
        ...
        while rodar:
            ...
            controles = pygame.transform.scale(
                controles, (self.tela.get_width(), self.tela.get_height()))
            ...
            try:
                for evento in pygame.event.get():
                    ...
                    voltar = Botao_Clicavel(
                        "VOLTAR", 200, 100, (15, 15), 3, self.fonte)
    ...
    def tela_pausa(self):
        ...
        while pausado:
            ...
            controles = Botao_Clicavel("CONTROLES", 300, 120, (self.tela.get_width(
            )*5/12, self.tela.get_height()*2.7/5), 0, self.fonte)
            ...
            Interface.mostrar_texto(self, "PAUSADO", 150, (255, 255, 255), self.tela.get_width(
            )/2, self.tela.get_height()*1/9)
            Interface.mostrar_texto(self, "PRESSIONE Q PARA CONTINUAR E R PARA REINICIAR", 36, (
                255, 255, 255), self.tela.get_width()/2, self.tela.get_height()*2.5/3)
            pygame.display.update()
    ...
    def tela_derrota(self):
        ...
        """
        self.tela.fill((66, 47, 7))
        self.mostrar_texto("DERROTA", 300, (255, 255, 255),
                           self.tela.get_width()/2, self.tela.get_height()/6)
        reiniciar = Botao_Clicavel("TENTE NOVAMENTE", 300, 120, (self.tela.get_width(
        )/2.3, self.tela.get_height()*3.5/5), 6, self.fonte)
    ...
    def tela_vitoria(self):
        ...
        while rodar:
            self.tela.fill((66, 47, 7))
            self.mostrar_texto("PARABÉNS, VOCÊS PASSARAM!", 100, (255, 255, 255),
                               self.tela.get_width()/2, self.tela.get_height()/6)
            voltar = Botao_Clicavel("VOLTAR", 300, 120, (self.tela.get_width(
            )/2.3, self.tela.get_height()*3.5/5), 6, self.fonte)
            voltar.desenhar(self.tela)
...
class Botao_Clicavel:
    ...
    def desenhar(self, tela):
        ...
        pygame.draw.rect(tela, self.baixo_cor,
                         self.baixo_ret, border_radius=15)
